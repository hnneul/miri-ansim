...
//   node --experimental-strip-types scripts/left-turn-worklist.mjs
//
...
/** build-route-data.mjs 가 받아둔 굳혀둔 구간 응답. priority=DISTANCE → 5.16도로, TIME → 평화로. */
const SOURCES = ["route-DISTANCE.json", "route-TIME.json"];
