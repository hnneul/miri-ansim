 ...
 *
 * **칸마다 따로 부른다.** 칸으로 쪼개면 셋을 얻는다: 첫 칸만 오면 재생을 시작할 수 있고, 지금 어느 칸인지 정확히 알며,
