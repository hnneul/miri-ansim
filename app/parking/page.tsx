...
//
// 24시간 칩은 그리지 않는다. 와이어프레임에는 있지만 원본 CSV 1,657곳이 전부
// 평일+토요일+공휴일 00:00~23:59 라 눌러도 걸러낼 게 하나도 없다 — 눌러도 아무 일이 없는
// 칩을 놓느니 빼는 게 낫다. 대신 하단 시트 정보 줄에는 남긴다 (근거는 lib/parking.check.ts).
