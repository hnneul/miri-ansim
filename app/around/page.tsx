 ...
 * 안 고른 것은 속이 빈 24x30 단색, 고른 것은 44x55 주황에 로고를 넣는다.
 *
 ...
 *
 * 모양은 두 파일이 같은 path 다 — 머리는 원(중심 23,23 / r 21), 꼬리는 (23,56)에서 그 원에 그은
 * 접선 둘. viewBox 46x58 을 공유하니 크기만 달라지고 실루엣은 어긋나지 않는다.
 *
 * on 이 data: URI 가 아니라 **파일**인 이유 — 로고가 자동 벡터화로 딴 것이라 좌표가 6KB다.
