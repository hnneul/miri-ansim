          ...
          {photos.map((src, i) => (
            /*
              ...
              **확인창은 안 붙인다.** 아직 저장 전이고 기기에만 있는 것이라, "서버에 남는 것만
              ...
              본체 탭은 아무 일도 안 한다. **크게 보기는 안 만들기로 했다** — 여기서도, 기록 상세
              에서도(2026-08-20 결정). 그러니 이 자리는 나중을 위해 비워 둔 게 아니라 비어 있는
              것이 결론이다. 그래도 무동작인 채 두는 편이 낫다: 사진을 탭하는 손은 크게 보려는
              손이라, 그 탭에 삭제를 도로 물리면 위에 적은 문제가 그대로 돌아온다.
