...
export const INTERESTS = [
  { emoji: "🌊", label: "바다·해변", desc: "파도와 노을" },
  { emoji: "🌿", label: "오름·숲", desc: "가벼운 산책" },
  { emoji: "🏛️", label: "전시·박물관", desc: "비 오는 날도 좋아요" },
  { emoji: "🍜", label: "시장·맛집", desc: "제주 로컬 음식" },
  { emoji: "📷", label: "카페·포토스팟", desc: "사진 남기기" },
  { emoji: "🐴", label: "아이와 함께", desc: "체험과 동물" },
];
