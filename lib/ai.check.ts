...
// --- ② 정상 응답은 통과한다 ---
// 숫자는 이 픽스처가 실제로 계산한 값이어야 한다 (추천점수 fast 64.7 / safe 75.6).
// 처음엔 실제 화면에서 본 값을 적었다가 ④의 검증에 걸렸다 — 검증기가 의도대로 동작한다는 뜻이다.
const 정상 = {
  summary: "5.16도로 경유는 5분 더 걸리고 추천점수도 64.7점으로 더 낮습니다.",
  briefing: [
    "평화로 경유를 추천합니다. 5.16도로 경유는 추천점수 64.7점으로 부담이 더 큽니다.",
